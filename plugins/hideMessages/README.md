...
Hide messages, or a whole chat's history, from your own Discord.

> [!NOTE]
> Nothing is deleted. The messages stay in the channel, the other person still sees
> everything, and bringing them back is instant because they were never actually removed.
...
> the time. Change that under *Hover button on messages*.
